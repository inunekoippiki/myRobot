...
class PROCESS_NODE_JUMP_POINT :public PROCESS_NODE {
public:
	PROCESS_NODE_JUMP_POINT(CONTAINER* c, STATIC_FONT* font, DRAWER::DRAWERS_SHADER* lineDrawers, PROCESS_NODE_LINER* processNodeLiner, PROCESS_NODE_MANAGER* processNodeManager);
	~PROCESS_NODE_JUMP_POINT();
...
private:
	...
	UI_INPUT_BOX_JUMP_POINT StringBoxInputJumpPoint;
