...
class PROCESS_NODE_INPUT :public PROCESS_NODE {
public:
	PROCESS_NODE_INPUT(CONTAINER* c, STATIC_FONT* font, DRAWER::DRAWERS_SHADER* lineDrawers, PROCESS_NODE_LINER* processNodeLiner, PROCESS_NODE_MANAGER* processNodeManager);
	~PROCESS_NODE_INPUT();
...
private:
	...
	UI_INPUT_BOX_VARIABLE StringBoxVariable;
	UI_INPUT_BOX StringBoxInputModule;
