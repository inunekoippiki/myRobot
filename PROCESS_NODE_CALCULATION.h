...
class PROCESS_NODE_CALCULATION :public PROCESS_NODE {
public:
	PROCESS_NODE_CALCULATION(CONTAINER* c, STATIC_FONT* font, DRAWER::DRAWERS_SHADER* lineDrawers, PROCESS_NODE_LINER* processNodeLiner, PROCESS_NODE_MANAGER* processNodeManager);
	~PROCESS_NODE_CALCULATION();
...
private:
	...
	UI_INPUT_BOX_OPERATOR StringBoxOperator;
	UI_INPUT_BOX_VARIABLE StringBoxVariable2;
	UI_INPUT_BOX_VARIABLE StringBoxVariable3;
