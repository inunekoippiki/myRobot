...
class PROCESS_NODE_FUNCTION :public PROCESS_NODE {
public:
	PROCESS_NODE_FUNCTION(CONTAINER* c, STATIC_FONT* font, DRAWER::DRAWERS_SHADER* lineDrawers, PROCESS_NODE_LINER* processNodeLiner, PROCESS_NODE_MANAGER* processNodeManager);
...
private:
	...
	UI_INPUT_BOX_FUNCTION StringBoxFunctionOperator;
